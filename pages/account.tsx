  ...
  return (
    <div>
      ...
      <main className="pt-24 mx-auto max-w-6xl pt-24 px-5 pb-12 transition-all  md:px-10">
        <div className="flex flex-col gap-x-4 md:flex md:items-center">
          <h1 className="text-3xl md:text4-xl">Account</h1>
          <div className="-ml-0.5 flex items-center gap-x-1.5">
            <img src="https://rb.gy/4vfk4r" alt="" className="h-7 w-7" />
            <p className="text-xs font-semibold text-[#555]">
              Members since {subscription?.creted}
            </p>
          </div>
        </div>
        ...
        >
          ...
          <p className="cursor-point text-blue-500 hover:underline md:text-right">
            Change plan
          </p>
        </div>
